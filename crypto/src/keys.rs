...
impl From<hash::Hash256> for KeyPair {
    fn from(secret_key: hash::Hash256) -> Self {
...
mod tests {
    ...
    fn it_works() {
        ...
        let kp = KeyPair::from(hash::Hash256::from("cae2b02f3a317b0ef61e694d899060f8434aef556bfe60239846533b52ab4608").unwrap());
